    ...
    >
      <form className={"DL01-form"}>
        <img
          ...
          className={"DL01-logo"}
          // src={
          //   "https://st2.depositphotos.com/3904951/8670/v/950/depositphotos_86701618-stock-illustration-speaker-icon.jpg"
          // }
        />
...
DashboardLogin01.getTheme = ({ palette, breakpoints }) => {
  const gradient = `linear-gradient(49deg, ${Color(palette.primary.main)
    ...
    .fade(0.7)
    .toString()} 100%)`;
  const cover = "https://www.unimoni.com/images/joomlart/slideshow/banner-01.jpg"

package com.unisolve.report.exception;
...
public class ExceptionHandlerControllerAdvice {
	 ...
	 */
	/*
	 * @ExceptionHandler(OrderNotFound.class) public
	 * ResponseEntity<ExceptionResponse> handleResourceNotFound(final OrderNotFound
